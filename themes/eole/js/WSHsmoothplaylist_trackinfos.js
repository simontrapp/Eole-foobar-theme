var properties_big = {
	...
	darklayout: window.GetProperty("BIG:darklayout", true),
    ...
    library_dark_theme: window.GetProperty("BIG:library_dark_theme", true),
    playlists_dark_theme: window.GetProperty("BIG:playlists_dark_theme", true),
    bio_dark_theme: window.GetProperty("BIG:bio_dark_theme", true),
	bio_stick2darklayout: window.GetProperty("BIG:bio_stick2darklayout",true),
    visualization_dark_theme: window.GetProperty("BIG:visualization_dark_theme", true),
...
var properties_mini = {
    ...
    library_dark_theme: window.GetProperty("MINI:library_dark_theme", true),
    playlists_dark_theme: window.GetProperty("MINI:playlists_dark_theme", true),
    bio_dark_theme: window.GetProperty("MINI:bio_dark_theme", true),
	bio_stick2darklayout: window.GetProperty("MINI:bio_stick2darklayout", true),
    visualization_dark_theme: window.GetProperty("MINI:visualization_dark_theme", true),
